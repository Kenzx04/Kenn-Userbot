...
# ====================== CONSTANT ===============================
INVALID_MEDIA = "```Media Tidak Valid Ngentot.```"
PP_CHANGED = "```Kontol, Foto Jamet Anda Telah Berhasil Diubah.```"
PP_TOO_SMOL = "```Gambar Terlalu Kecil Ngentot, Mohon Gunakan Kontol Yang Lebih Besar.```"
PP_ERROR = "```Kegagalan Terjadi Saat Proses Gambar, Foto Profil Gagal Diubah Goblok.```"

BIO_SUCCESS = "```Kontol, Bio Anda Telah Berhasil Diubah.```"

NAME_OK = "```Kontol, Nama Anda Telah Berhasil Diubah.```"
USERNAME_SUCCESS = "```Username Anda Sudah Diubah.```"
USERNAME_TAKEN = "```Mohon Maaf Ngentot, Username Itu Sudah Ada Yang Menggunakannya Bego.```"
# ===============================================================
